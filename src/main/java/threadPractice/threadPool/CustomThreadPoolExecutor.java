...
public class CustomThreadPoolExecutor {
	 ...
	 */
	public void init(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, int workQueueCount) {
		pool = new ThreadPoolExecutor(corePoolSize, maximumPoolSize, keepAliveTime, unit,
				new ArrayBlockingQueue<Runnable>(workQueueCount), new CustomThreadFactory(),
